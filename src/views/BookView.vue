...
const onPageTrackInput = () => {
  if (book.value.userPage < 0 || !book.value.userPage) book.value.userPage = 0;
...
<template>
  <main class="my-12">
      ...
      <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="grow flex justify-center md:justify-end items-center">
          <div class="flex flex-row md:flex-col gap-4 items-center">
            ...
            <span
              class="w-12 h-12 border-2 border-gray-700 rounded-lg align-middle flex justify-center items-center"
            >
      ...
      <div class="flex flex-col gap-2">
        ...
        <div class="flex justify-between items-center">
          <h3 class="text-xl font-semibold">
            ...
            <span> through the book. </span>
          </h3>

          <button
            @click="isPageTrackOpen = true"
    ...
    <Dialog
      :open="isPageTrackOpen"
      @close="isPageTrackOpen = false"
      class="relative z-50"
    >
      ...
      <div class="fixed inset-0 flex items-center justify-center p-4">
        ...
        >
          <DialogTitle class="text-xl font-bold"
            >Set your current page</DialogTitle
          >

          <div class="flex items-center gap-2">
            <input
              type="number"
              v-model="book.userPage"
              @input="onPageTrackInput"
              :min="0"
            ...
            <label
              class="p-2 w-full bg-gray-100 border-2 rounded-md text-center"
            >
              {{ book.numberOfPages }}
            </label>
          </div>
